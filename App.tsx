...
const Header = () => (
  <header className="bg-slate-900 text-white py-8 px-4 text-center border-b border-slate-700 relative overflow-hidden">
    ...
    <div className="absolute top-6 right-6 z-20 flex items-center gap-4 text-slate-400">
      <button className="hover:text-white transition-colors" title="Teilen">
        <Share2 size={20} />
      </button>
    ...
    <div className="max-w-md mx-auto mt-20 p-8 bg-white rounded-2xl shadow-xl border border-slate-200">
      <div className="text-center mb-8">
        ...
        <div className="mb-6 space-y-1">
          ...
          <p className="text-sm text-slate-600">Erstellung von bis zu 3 gleichzeitig - personalisierten und individuellenTrauerreden. Bei gleichzeitiger Integration von jeweils 2 unterschiedlichen Zitaten - sowie der Auswahl von 2 Zeremonien und 6 Tonalitäten pro Rede.</p>
          <p className="text-xs text-slate-400 uppercase tracking-widest">Version 1.2</p>
        </div>
      ...
      <div className="mt-8 text-center space-y-1">
        <p className="text-slate-500 text-sm font-medium">www.pepe-verlag.de</p>
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
        ...
        <div className="flex gap-2">
          ...
          <button 
            ...
            className="bg-emerald-600 text-white px-6 py-3 rounded-lg hover:bg-emerald-700 shadow-lg flex items-center gap-2 font-bold"
          >
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
            </svg>
...
export default function App() {
  ...
  const handleStartGeneration = async () => {
    setState(prev => ({ ...prev, step: 'generation', isGenerating: true }));
    ...
    setState(prev => ({ ...prev, outlines: newOutlines, isGenerating: false }));
  };
